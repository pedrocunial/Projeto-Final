...
def credits():
	...
	img = pygame.image.load(os.path.join("IMG Credits",'dickbutt.png'))
	img2 = pygame.image.load(os.path.join("IMG Credits",'sperm.png'))
	bd = pygame.image.load(os.path.join("IMG Credits",'background.png'))
	fpsTime = pygame.time.Clock()

	img2 = pygame.transform.scale(img2,(12,37))
	img2 = pygame.transform.rotate(img2,-30)

	img3 = pygame.image.load(os.path.join("IMG Credits",'shit.png'))
