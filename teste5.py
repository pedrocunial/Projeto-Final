...
p1_walkRight1 = pygame.image.load('pedro_right1.png')
p1_walkRight2 = pygame.image.load('pedro_right2.png')
p1_walkRight3= pygame.image.load('pedro_right3.png')
p1_walkLeft1= pygame.image.load('pedro_left1.png')
p1_walkLeft2= pygame.image.load('pedro_left2.png')
p1_walkLeft3= pygame.image.load('pedro_left3.png')
p1_punchLeft= pygame.image.load('pedro_punch_left.png')
p1_punchRight= pygame.image.load('pedro_punch_right.png')
p1_jumpRight = pygame.image.load('pedro_jump_right.png')
p1_jumpLeft = pygame.image.load('pedro_jump_left.png')

#Menu
background_menu = pygame.image.load('background_menu.png')
start_1 = pygame.image.load('start_1.png')
start_2 = pygame.image.load('start_2.png')
close_1 = pygame.image.load('close_1.png')
close_2 = pygame.image.load('close_2.png')
...
def Menu():
	pygame.mixer.music.load('quimica-do-amor.wav')
...
def runGame():
	...
	g = 0.5
	jump_count = 0
	pygame.mixer.music.load('fd_8bits.mp3')
